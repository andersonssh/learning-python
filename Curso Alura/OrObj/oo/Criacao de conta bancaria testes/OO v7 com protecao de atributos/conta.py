...
class Conta:
    ...
    def transfere(self, conta, valor):
        if self.saca(valor):
            ...
            conta.historico.transacoes.append(
                '\033[32mTransferencia de \033[mR$ \033[34m{:5.2f}\033[32m recebida de \033[m{}'.format(valor,
                                                                                                        self.titular.nome))
            self.historico.transacoes.append(
                '\033[31mTranferencia de \033[mR$ \033[34m{:5.2f} \033[31mpara \033[m{}'.format(valor,
                                                                                                conta.titular.nome))
            return True
        else:
            return False
    ...
    def extrato(self):
        ...
        print('Saldo atual da conta: R$ {:7.2f}'.format(self.__saldo))
